...
public class CadastroVeiculoJD extends javax.swing.JDialog {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try{
            this.veiculo.setNome(txtNome.getText());
            this.veiculo.setCPF(txtCPF.getText());
            // sintaxe para conversão: LocalDate.parse(String com data, máscara)
            this.veiculo.setDataNascimento(LocalDate.parse(txtDtNascimento.getText(), formatter));
            this.veiculo.setTelefone(txtTelefone.getText());
    ...
    public void setClient(Veiculo veiculo) {
        this.veiculo = veiculo;
        txtNome.setText(veiculo.getNome());
        txtCPF.setText(veiculo.getCPF());
        txtTelefone.setText(veiculo.getTelefone());
        txtDtNascimento.setText(veiculo.getDataNascimento().format(formatter));
    }
